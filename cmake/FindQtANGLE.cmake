...
find_library(QtANGLE_EGL_LIB_DBG  NAME libEGLd    PATHS ${QtANGLE_LIB_DIR} REQUIRED NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
find_library(QtANGLE_EGL_LIB_REL  NAME libEGL     PATHS ${QtANGLE_LIB_DIR} REQUIRED NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
find_library(QtANGLE_GLES_LIB_DBG NAME libGLESv2d PATHS ${QtANGLE_LIB_DIR} REQUIRED NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH)
...
if(WIN32)
    ...
    get_filename_component(QtANGLE_EGL_BIN_DBG ${QtANGLE_RUNTIME_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}libEGLd${CMAKE_SHARED_LIBRARY_SUFFIX} ABSOLUTE)
    get_filename_component(QtANGLE_EGL_PDB_DBG ${QtANGLE_RUNTIME_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}libEGLd.pdb ABSOLUTE)
    get_filename_component(QtANGLE_EGL_BIN_REL ${QtANGLE_RUNTIME_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}libEGL${CMAKE_SHARED_LIBRARY_SUFFIX} ABSOLUTE)
    ...
    get_filename_component(QtANGLE_GLES_BIN_DBG ${QtANGLE_RUNTIME_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}libGLESv2d${CMAKE_SHARED_LIBRARY_SUFFIX} ABSOLUTE)
    get_filename_component(QtANGLE_GLES_PDB_DBG ${QtANGLE_RUNTIME_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}libGLESv2d.pdb ABSOLUTE)
    get_filename_component(QtANGLE_GLES_BIN_REL ${QtANGLE_RUNTIME_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}libGLESv2${CMAKE_SHARED_LIBRARY_SUFFIX} ABSOLUTE)
    ...
    list(APPEND QtANGLE_BINARIES
        ${QtANGLE_EGL_BIN_DBG}  ${QtANGLE_GLES_PDB_DBG}
        ${QtANGLE_EGL_BIN_REL}  ${QtANGLE_GLES_PDB_REL}
...
message(STATUS "Making QtANGLE ${Qt5_VERSION}")
